...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeFlow = {
	   ...
	   */
	  applyOpts: function applyOpts(value, options) {
	    // debugger
	    var self = this;
	    var _defaults = {
	      stream: true,
	    ...
	    var applyFn = function applyFn(_x, _x2) {
	      ...
	      _function: while (_again) {
	        ...
	        if (firstFn === undefined) {
	          ...
	          _x = firstFn.apply(self._this, arg);
	          _x2 = restFn;
	          _again = true;
	          continue _function;
	        }
	    ...
	    var applyOpt = function applyOpt(argArr, optFn) {
	      var mapApply = function mapApply(arr, fns) {
	        // debugger;
	    ...
	    var optCycle = function optCycle(val, opts) {
	    ...
	    //stream opt
	    return this.streamOpts.length ? optCycle(value, this.streamOpts) : value;
	  },
	  /*
	  Processes and shit
	   */
	  process: function process() {
	    // debugger
	    var self = this;
	    var applyArgs = function applyArgs(val) {
	      if (val === undefined) {
	        return;
	      }
	      //apply res opts
