...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeFlow = {
	  ...
	  checkOpts: function checkOpts(args) {
	    ...
	    var allOpts = ['_stream', '_objReturn', '_objKeep', '_flow', '_args', '_flatten', '_start', '_res', '_end', '_option', '_this'];
	  ...
	  process: function process() {
	    ...
	    if (this.firstIsFn) {
	      ...
	      return this._L.isFn(rtn) ? rtn.apply(self._this, this.argsToApply._fnArgs || []) : rtn;
