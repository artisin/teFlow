(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("lodash.isfunction"), require("lodash.isobject"), require("lodash.memoize"), require("lodash.defaults"), require("defclass"));
	else if(typeof define === 'function' && define.amd)
		define(["lodash.isfunction", "lodash.isobject", "lodash.memoize", "lodash.defaults", "defclass"], factory);
	else if(typeof exports === 'object')
		exports["teFlow"] = factory(require("lodash.isfunction"), require("lodash.isobject"), require("lodash.memoize"), require("lodash.defaults"), require("defclass"));
	else
		root["teFlow"] = factory(root["lodash.isfunction"], root["lodash.isobject"], root["lodash.memoize"], root["lodash.defaults"], root["defclass"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defaults2 = __webpack_require__(4);
	var defclass = __webpack_require__(5);
	/*
	teFlow
	 */
	var TeFlow = defclass({
