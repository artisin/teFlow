(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("lodash.isarray"), require("lodash.isfunction"), require("lodash.isobject"), require("lodash.memoize"), require("lodash.defaults"), require("augment"));
	else if(typeof define === 'function' && define.amd)
		define(["lodash.isarray", "lodash.isfunction", "lodash.isobject", "lodash.memoize", "lodash.defaults", "augment"], factory);
	else if(typeof exports === 'object')
		exports["teFlow"] = factory(require("lodash.isarray"), require("lodash.isfunction"), require("lodash.isobject"), require("lodash.memoize"), require("lodash.defaults"), require("augment"));
	else
		root["teFlow"] = factory(root["lodash.isarray"], root["lodash.isfunction"], root["lodash.isobject"], root["lodash.memoize"], root["lodash.defaults"], root["augment"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var augment = __webpack_require__(6);
	var defclass = augment.defclass;
	/*
	teFlow
	 */
	var TeFlow = defclass({
	  constructor: function constructor(thisArg) {
	    var self = this;
	    self._self = self;
	    self.userOptions = {};
	    //no opts return
...
/***/ function(module, exports) {
	...
	module.exports = require("augment");
